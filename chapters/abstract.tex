...
Inoltre, è possibile individuare approcci più sofisticati, come MTL e \term{free monad}, per sopperire ad alcuni problemi legati all'uso delle semplici monadi.
...
L'obiettivo di questa tesi è effettuare una rassegna degli approcci sopra elencati: partendo da una descrizione del concetto di monade verrà mostrato come sia possibile implementare MTL e \term{free monad} nel linguaggio di programmazione Scala.
