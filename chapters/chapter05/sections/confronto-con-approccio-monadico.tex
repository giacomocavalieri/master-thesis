...
def mixedSideEffects[I[_]: With[ConsoleDSL]: With[FailDSL]]() =
  ...
  yield ()
\end{lstlisting}
Per poter comprendere l'esempio un programmatore deve essere a conoscenza di meccanismi del linguaggio non banali come il passaggio di istanze implicite, i context bound e gli \emph{higher-kinded types}.
