...
Un \term{parser} può essere modellato come una funzione che consuma una stringa (o una sua porzione) producendo un risultato come un AST. Nel caso in cui la stringa non sia conforme al linguaggio descritto dal \term{parser} questo processo potrebbe fallire senza produrre alcun valore.
