...
\end{lstlisting}
\todo{Forse questi esempi sarebbero potuti essere introdotti in precedenza nel capitolo dedicato alle monadi e mostrati per maybe e state}
