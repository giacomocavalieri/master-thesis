...
In Scala è possibile codificare una \term{type class} sfruttando il passaggio implicito di parametri~\cite{cit:type-classes-as-objects-and-implicits}. La definizione di una \term{type class} si riduce quindi a indicare un'interfaccia:
